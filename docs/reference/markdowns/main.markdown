...
[method](#TODO) or [field](#TODO). It is a [simple statement](#statements) whose single argument the [name](#names-and-labels) of 
...
Read more aboou this syntax [here](http://docs.oracle.com/javase/specs/jvms/se8/html/jvms-4.html#jvms-4.7.9.1).
...
This statement marks a [class](#TODO), [method](#TODO) or [field](#TODO) as synthetic, that is, as being generated by the compiler itself without having a 
corresponding declaration in the underlying [source file](#TODO). It consists of a single keyword as illustrated in the following EBNF expression:
