...
public interface AnnotatedInterface {
	...
	@TestInvisibleAnnotation
	public void annotatedMethod(@TestAnnotation(booleanValue = false, byteValue = 1, charValue = 2,enumValue=Days.THURSDAY, clazzValue = Void.class, intValue = 5, longValue = 6, shortValue = 7, nestedAnnotation = @NestedAnnotation, intArrayValue = {2,5,6})  @TestInvisibleAnnotation int a);
