...
public class MacroParserTest extends AbstractParserTestCase {
	...
	public void test() {
		...
		Assert.assertEquals(7, call.getArguments().size());
		...
		Assert.assertEquals("this.class", ((FieldReference)call.getArguments().get(5)).getClassName());
		...
		Assert.assertEquals("this.class", ((MethodReference)call.getArguments().get(6)).getClassName());
