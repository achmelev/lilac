...
public class SpingWebMVCGenerateStackMapsTest extends
	...
	private String getDepsList() {
		return "org.springframework:spring-core:jar:4.0.6.RELEASE:compile\r\n" + 
				...
				"org.apache.tiles:tiles-mvel:jar:2.2.2:compile\r\n" + 
				...
				"org.apache.tiles:tiles-freemarker:jar:2.2.2:compile\r\n" + 
				...
				"org.apache.tiles:tiles-compat:jar:2.2.2:compile\r\n" + 
				...
				"org.apache.tiles:tiles-ognl:jar:2.2.2:compile\r\n" + 
				"org.bouncycastle:bcprov-jdk14:jar:1.38:compile\r\n" + 
				"ognl:ognl:jar:2.7.3:compile\r\n" + 
				"org.apache.tiles:tiles-extras:jar:2.2.2:compile\r\n" + 
	...
	protected boolean filter(String name) {
		return !"org/springframework/web/servlet/view/tiles3/SpringLocaleResolver.class".equals(name)
		&& !"org/springframework/web/servlet/view/tiles3/AbstractSpringPreparerFactory.class".equals(name)
		&& !"org/springframework/web/servlet/view/tiles3/TilesConfigurer.class".equals(name)		
		&& !"org/springframework/web/servlet/view/tiles3/TilesConfigurer$CompositeELResolverImpl.class".equals(name)		
		&& !"org/springframework/web/servlet/view/tiles3/TilesView.class".equals(name)		
		&& !"org/springframework/web/servlet/view/tiles3/TilesConfigurer$SpringTilesContainerFactory.class".equals(name)		
		&& !"org/springframework/web/servlet/view/tiles3/SpringBeanPreparerFactory.class".equals(name)		
		&& !"org/springframework/web/servlet/view/tiles3/SimpleSpringPreparerFactory.class".equals(name)		
		;
	}
