...
public class JasmConsts {
	...
	public static int ANNOTATION_TARGET_TYPE_PATHKIND_ARRAY=0;
	public static int ANNOTATION_TARGET_TYPE_PATHKIND_NESTED=1;
	public static int ANNOTATION_TARGET_TYPE_PATHKIND_TYPE_BOUND=2;
	public static int ANNOTATION_TARGET_TYPE_PATHKIND_TYPE_ARGUMENT=3;
